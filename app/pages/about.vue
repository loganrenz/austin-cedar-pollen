    ...
    <section class="content-card">
      ...
      <div class="facts-grid">
        <div class="fact-item">
          ...
          <div>
            <h3 class="fact-title">Geographic Position</h3>
            <p class="fact-text">Austin sits at the eastern edge of the Hill Country, directly in the pollen drift path from millions of juniper trees.</p>
          </div>
        </div>
        <div class="fact-item">
          <div class="fact-icon">
          ...
          <div>
            <h3 class="fact-title">Cold Front Triggers</h3>
            <p class="fact-text">Winter cold fronts cause male juniper trees to release massive clouds of pollen simultaneously, creating sudden spikes.</p>
          </div>
        </div>
        <div class="fact-item">
          <div class="fact-icon">
          ...
          <div>
            <h3 class="fact-title">Population Growth</h3>
            <p class="fact-text">Many Austin transplants develop cedar allergies after 1–3 years of exposure. The immune system becomes sensitized over time.</p>
          </div>
        </div>
        <div class="fact-item">
          <div class="fact-icon">
          ...
          <div>
            <h3 class="fact-title">Drought Resistance</h3>
            <p class="fact-text">Ashe Juniper thrives in Texas drought conditions. While other vegetation declines, juniper populations continue expanding.</p>
          </div>
        </div>
      </div>
    </section>
